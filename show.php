        ...
        <div class="table-wrapper">
            <div class="table-title ">
                <div class="row jumbotron bg-dark text-white">
					...
					<div class="col-sm-2">
                        <h2>	<a href="./index.php" class="btn btn-primary text-dark" ><b> Add Employee</b></a></h2>
...
<td><img src='<?php echo $arr['imagepath']?>' height="70px" width="100px"></td> 
    ...
    <td>						
        <a href="edit.php?que=<?php echo $arr['id']?>" class="edit "><i style="color:yellow;" class="fas fa-pencil-alt "></i></a>&nbsp;&nbsp;
        <a href="change.php?que=<?php echo $arr['id']?>" class="image "><i style="color:blue" class="fas fa-file-image"></i></a>&nbsp;&nbsp;
